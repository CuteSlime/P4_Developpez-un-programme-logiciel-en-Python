...
# créer un tournois
    ...
    def sub_main_menu(self, view_name, menu_name_list, menu_name_create):
        choix = getattr(self.view, 'menu_tournois')
        match choix:
            case "1":
                return self.menu_list(menu_name_list, menu_name_list)
            case "2":
    ...
    def menu_create(self, view_name, list_objects):
        ...
        match obj[0]:
            case "Tournoi":
                obj = Tournoi(
                    obj[1], obj[2], obj[3], obj[4], nb_tour=obj[5])
        print("/!\\", self.list_tournois)
        add_to_database(obj, self.list_tournois, "tournois", Tournoi)
        print("/!\\", self.list_tournois)
